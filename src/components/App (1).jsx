...
const roadImageVariants = {
  hidden: { opacity: 0, clipPath: "circle(0% at 50% 50%)" },
  visible: { opacity: 1, clipPath: "circle(75% at 50% 50%)", transition: { duration: 1.0, ease: ROAD_EASE } },
  exit: { opacity: 0, clipPath: "circle(0% at 50% 50%)", transition: { duration: 0.6, ease: ROAD_EASE } },
};
...
const RoadAhead = () => {
  ...
  return (
    <section id="road-ahead" className="py-28 md:py-40 relative overflow-hidden">
      <style>{`
        @keyframes cep-road-scan{
          0%{ transform: translateY(-100%); opacity: 0; }
          12%{ opacity: 0.8; }
          88%{ opacity: 0.5; }
          100%{ transform: translateY(100%); opacity: 0; }
        }
        .cep-road-scanline{ animation: cep-road-scan 1.1s ${`cubic-bezier(${ROAD_EASE.join(",")})`} both; }
        .cep-road-bracket{ position:absolute; width:16px; height:16px; opacity:0.9; }
        @media (prefers-reduced-motion: reduce){
          .cep-road-scanline{ animation:none; }
        }
      `}</style>
              ...
              {active && active.image && (
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className="cep-road-scanline pointer-events-none absolute left-0 right-0"
                      style={{ height: "40%", background: "linear-gradient(to bottom, transparent, var(--accent-soft), transparent)" }}
                    />
