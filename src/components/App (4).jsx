    ...
    <section id="experience" className="py-28 md:py-40">
      <div className="max-w-6xl mx-auto px-5 md:px-8">
        ...
        <div className="mt-12 flex flex-col md:flex-row gap-8 md:gap-12 items-start">
          ...
          <div className="max-w-2xl w-full" onMouseLeave={() => setHoveredIndex(null)}>
            {EXPERIENCE.map((e, i) => (
          ...
          {/* the case file — a small stack of records sitting in the space
              that would otherwise just be empty. Squared off, no tilt —
              a tidy stack, not a scattered one. Hovering (or focusing) an
          ...
          <div
            ...
            style={{ width: 320, height: 420, position: "sticky", top: 140 }}
          >
            {EXPERIENCE.map((e, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div style={{ width: "100%", aspectRatio: "4 / 5", overflow: "hidden", borderRadius: 5 }}>
                      <ImageSlot src={e.image} alt={e.title} placeholder="Photo" className="w-full h-full" />
                    </div>
                    <div className="mt-2.5 font-mono text-[10px] tracking-widest uppercase" style={{ color: "var(--ink-faint)" }}>
                      {e.tag} · {e.year}
                    </div>
                  </div>
                </motion.div>
